...
export default function Documents(){
  ...
  return <DashboardLayout><div className="space-y-5">
    ...
    <section className="rounded-2xl border border-[var(--cfit-border)] bg-[var(--cfit-surface-primary)]">
      ...
      <PaginationFooter count={data.count} label="documento(s)" page={page} hasPrevious={Boolean(data.previous)} hasNext={Boolean(data.next)} onPrevious={()=>setPage(value=>Math.max(1,value-1))} onNext={()=>setPage(value=>value+1)}/>
    </section>
