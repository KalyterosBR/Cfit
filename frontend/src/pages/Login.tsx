...
export default function Login() {
    ...
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-x-hidden bg-[#f4f7fb] px-3 py-4 [@media(max-height:820px)]:items-start max-[339px]:px-2 max-[339px]:py-2 sm:px-5 sm:py-7 lg:py-10">
            ...
            <div className="relative grid w-full max-w-[1040px] overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_32px_90px_-48px_rgba(15,23,42,0.55)] max-[339px]:rounded-[1.25rem] lg:grid-cols-[0.8fr_1.2fr]">
                ...
                <section className="bg-[#081426] p-6 max-[339px]:px-5 max-[339px]:py-5 sm:p-8 lg:p-10" aria-label="Autenticação">
