    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-[#f4f7fb]">
            ...
            <main><section className="relative isolate overflow-hidden border-b border-slate-200 bg-[#f4f7fb]">
                ...
                <div className="relative mx-auto grid w-full max-w-[1600px] gap-9 px-6 py-10 md:py-12 lg:min-h-[560px] lg:grid-cols-[minmax(0,1.05fr)_minmax(430px,0.95fr)] lg:items-center lg:px-10">
                    <HomeHero />
