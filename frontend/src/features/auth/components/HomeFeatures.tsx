...
export default function HomeFeatures() {
    return (
        <section id="recursos" className="relative scroll-mt-[78px] overflow-hidden bg-white py-12 md:py-14 lg:py-10">
            ...
            <div className="relative mx-auto max-w-[1600px] px-6 lg:px-10">
                ...
                <div className="mt-6 border-y border-slate-200 lg:mt-4">
                ...
                <div className="mt-6 grid overflow-hidden rounded-[1.2rem] bg-[#06101f] text-white lg:mt-4 lg:grid-cols-[0.42fr_0.58fr]">
