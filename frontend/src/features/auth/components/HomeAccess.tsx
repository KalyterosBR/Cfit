    ...
    return (
        <section className="relative overflow-hidden bg-white py-24 md:py-32">
            ...
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute -left-48 top-1/2 h-[34rem] w-[34rem] -translate-y-1/2 rounded-full bg-blue-500/[0.05] blur-[120px]" />

                <div className="absolute -right-48 bottom-0 h-[34rem] w-[34rem] rounded-full bg-cyan-400/[0.05] blur-[120px]" />
            ...
            <div className="relative mx-auto max-w-7xl px-6">
                ...
                <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
                    <div>
                        ...
                        <h2 className="mt-6 max-w-xl text-4xl font-black leading-[1.03] tracking-[-0.045em] text-slate-950 md:text-5xl">
                    ...
                    <div className="max-w-xl lg:justify-self-end">
                        <p className="text-lg leading-8 text-slate-600">
                            Identificação, validação e acesso trabalham juntos
                            para tornar a entrada mais rápida para o aluno e
                            mais segura para a academia.
                        </p>
                    </div>
                </div>
                ...
                {/* ÁREA PRINCIPAL */}
                <div className="mt-16 grid gap-7 lg:grid-cols-[0.78fr_1.22fr]">
                    {/* FLUXO */}
                    <div className="flex flex-col justify-between rounded-[2rem] border border-slate-200 bg-[#f8fafc] p-7 md:p-9">
                        <div>
                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
                                Acesso inteligente
                            </p>

                            <h3 className="mt-3 max-w-sm text-2xl font-bold tracking-[-0.03em] text-slate-950">
                                            ...
                                            <div className="relative flex flex-col items-center">
                                                <div
                                                    className={`relative z-10 flex h-11 w-11 items-center justify-center rounded-xl border ${isLast
                                                            ? "border-blue-600 bg-blue-600 text-white shadow-[0_12px_30px_-12px_rgba(37,99,235,0.6)]"
                                                ...
                                                {!isLast && (
                                                    <div className="absolute bottom-0 top-11 w-px bg-slate-200" />
                                                )}
                                            </div>
                    ...
                    {/* DEMONSTRAÇÃO */}
                    <div className="relative overflow-hidden rounded-[2rem] bg-[#050b1c] p-5 shadow-[0_35px_80px_-45px_rgba(15,23,42,0.7)] md:p-7">
                        {/* EFEITOS */}
                        <div className="pointer-events-none absolute -right-32 -top-32 h-80 w-80 rounded-full bg-blue-600/20 blur-[100px]" />

                        <div className="pointer-events-none absolute -bottom-32 left-10 h-72 w-72 rounded-full bg-cyan-400/10 blur-[100px]" />
                                ...
                                <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-5">
                                    ...
                                    <div className="flex min-h-[300px] flex-col items-center justify-center text-center">
                                        <div className="relative flex h-32 w-32 items-center justify-center">
                                            ...
                                            <div className="absolute inset-3 rounded-[1.6rem] border border-blue-500/20" />

                                            <div className="absolute inset-7 rounded-full bg-gradient-to-br from-blue-600/20 to-cyan-400/10 blur-xl" />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-5">
                                        ...
                                        <div className="mt-5 flex items-center justify-between gap-4">
                                            ...
                                            <span className="rounded-full bg-emerald-400/[0.08] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.12em] text-emerald-300">
                                                Ativo
                                            </span>
                                        </div>
                                    ...
                                    {/* ACESSO LIBERADO */}
                                    <div className="relative overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-blue-600 to-cyan-500 p-5 text-white">
