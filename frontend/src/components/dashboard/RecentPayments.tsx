...
export default function RecentPayments({
    ...
    return (
        <div className={variant === "canvas" ? "border-l border-slate-200/80 py-7 pl-6 lg:pl-8" : "rounded-[1.5rem] border border-slate-200/80 bg-white p-5 shadow-[0_18px_45px_-32px_rgba(15,23,42,0.28)] sm:p-6"}>
            <div className="mb-5">
